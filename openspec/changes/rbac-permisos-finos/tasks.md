...
- [ ] 8.1 Verificar cobertura ≥80% líneas / ≥90% reglas de negocio del módulo RBAC ⚠️ pendiente hasta tener PostgreSQL (--run-db)
- [x] 8.2 Verificar que ningún archivo backend supera 500 LOC; refactorizar si hace falta ✅ todos <500 LOC
- [ ] 8.3 Confirmar PA-25 (permisos exactos de NEXO) con el usuario y ajustar el seed si corresponde ⚠️ PENDIENTE — necesita decisión del usuario
