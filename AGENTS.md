...
> ⚠️ **Preguntas ALTA pendientes** (resolver antes de tocar el dominio afectado): **PA-01** catálogo de materias (Materia vs InstanciaDictado), **PA-07** cohortes ↔ carrera. Ver [10_preguntas_abiertas.md](knowledge-base/10_preguntas_abiertas.md). No codees estructura académica (C-06) sin cerrar las preguntas que lo bloquean.
> ✅ **PA-22** y **PA-23** (claves de Plus y acumulación) resueltas el 2026-06-20 — C-18 liquidaciones ya no está bloqueado por estas preguntas.
